...
<body>
	...
	<form action="updateGame.do" method="post" class="form-group">
		...
		<label for="playScore">Play Score:</label> <input class="form-control" type="text" name="playScore" id="playScore" value="${game.playScore }"/>	
